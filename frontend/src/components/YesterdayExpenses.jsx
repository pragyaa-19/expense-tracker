...
function YesterdayExpensesList({ expenses, onDelete, onUpdate, theme }) {
  ...
  return (
    <div className="mb-4">
      <h5 className="mb-3">Yesterday’s Expenses</h5>

      {expenses.length === 0 && (
       <div className={`p-3 text-center rounded ${theme === "dark" ? "bg-secondary text-light" : "bg-light text-dark"}`}>
          <h6>No expenses yesterday 📅</h6>
          <small className="text-muted">Good control!</small>
        </div>
...
export default YesterdayExpensesList;
